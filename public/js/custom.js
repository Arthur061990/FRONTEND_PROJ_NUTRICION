...
function selectGender(gender) {
  ...
  if (gender === 'male') {
    $('#male-img').attr('src', '/images/select-gender/male-select-img.png');
    $('#female-img').attr('src', '/images/select-gender/female.png');
  } else if (gender === 'female') {
    $('#female-img').attr('src', '/images/select-gender/female-sellect-img.png');
    $('#male-img').attr('src', '/images/select-gender/male.png');
  }
}
$(document).ready(function() {
  selectGender('female'); 
